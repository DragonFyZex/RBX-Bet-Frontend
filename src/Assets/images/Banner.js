...
const SvgComponent = ({windowWidth, children}) => (
  <div style = {{display: 'flex', flexDirection: "column", justifyContent: "center", marginTop: windowWidth < 1000 ? "1%" : "1%", height: windowWidth < 1000 ? "25%" : "25%", }}>
    <div style = {{height: "100%", alignSelf: "center", }} dangerouslySetInnerHTML={{__html: `
