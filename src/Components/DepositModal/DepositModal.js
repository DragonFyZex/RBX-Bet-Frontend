...
export default ({open, accept, cancel, userId}) => {
    ...
    useEffect(() => {
        ...
        (async () => {  
            const items = await axios.get(`https://cors.io/?https://inventory.roblox.com/v1/users/${userId}/assets/collectibles?sortOrder=Asc&limit=100`)
                ...
                <div className="over18ModalContainer">
                    ...
                    <div className = "modalButtonContainer">
                        <p className = "acceptButton" 
                            onClick={async () => {
                                // get new Prices
                                const newItems = await axios.get(`https://cors.io/?https://inventory.roblox.com/v1/users/${userId}/assets/collectibles?sortOrder=Asc&limit=100`)
