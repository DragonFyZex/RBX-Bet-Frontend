...
export default ({sidebarIsOpen, setSidebarIsOpen}) => (
    <div className="headerContainer">
        ...
        <Link to="/" className="screenText screenTextClickable" style={{marginLeft: 'auto'}}>Play</Link>
        <a className="screenText screenTextClickable" href="https://discord.gg/BmPFzTT" target="_blank"  style={{marginLeft: '2%'}}>Discord</a>
